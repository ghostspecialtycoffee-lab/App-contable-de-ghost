...
**Ghost Specialty Coffee ↔ Bit Hotels El Peñón** · Agosto 2026 · COP  
Cifras de trabajo para negociación; escandallo real a 30 días.
...
| Concepto | COP |
|----------|-----|
| Precio B2B hotel | 13.500 |
| Costo Ghost estimado (food + bebida) | 6.200 |
| Food cost | **46%** |
| Margen bruto Ghost | **7.300 (~54%)** |
| Valor percibido huésped (ref. mercado boutique) | 28.000 – 38.000 |

### Desglose costo Ghost (objetivo buffet)
...
Si el food cost real supera 55% durante 30 días, se revisa porción, mermas o precio.

## 3. Cápsulas y drips

| Producto | Precio hotel | Costo Ghost est. | Margen |
|----------|--------------|------------------|--------|
| Cápsula | 1.700 | 900 – 1.100 | 600 – 800 |
| Drip | 2.000 | 1.100 – 1.300 | 700 – 900 |
| Kit 2+1 | 5.400 | ~3.100 | ~2.300 |

## 4. Redes sociales

| Concepto | COP |
|----------|-----|
| Plan aliado mensual | 690.000 |
| Setup opcional | 250.000 |
...
5. Firmas: administración hotel + Ghost.  
